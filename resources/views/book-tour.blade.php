            ...
            <div class="form-book-tour">
                <div class="form-group">
                    ...
                    <div class="form-subgroup">
                        ...
                        <button id="btn-change-tour" onclick="event.preventDefault(); window.location.href='{{ route('tour_places') }}'">Change</button>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group" id="avail-seats">
                    ...
                    <input type="number" id="seat-count" name="BookedSeats" min="1" max="12" required autofocus>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="book-by" name="BookedBy" placeholder="Type your Full Name" required>
                </div>
